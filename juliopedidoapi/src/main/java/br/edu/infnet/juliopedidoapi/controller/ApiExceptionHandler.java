package br.edu.infnet.juliopedidoapi.controller;
...
public class ApiExceptionHandler {
	...
	public ResponseEntity<ApiError> handleNotFound(PedidoNaoEncontradoException ex, HttpServletRequest request) {
		return buildResponse(HttpStatus.NOT_FOUND, ex.getMessage(), request, null);
	}

	@ExceptionHandler(LocalidadeNaoEncontradaException.class)
	public ResponseEntity<ApiError> handleLocalidadeNotFound(LocalidadeNaoEncontradaException ex,
			HttpServletRequest request) {
		return buildResponse(HttpStatus.NOT_FOUND, ex.getMessage(), request, null);
	}
