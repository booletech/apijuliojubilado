...
public class CarrosService {
    ...
    public String buscarModelIdPorNome(String vehicleType, String brandId, String modelName) {
        ...
        if (modelos == null || modelos.isEmpty()) return null;

        return modelos.stream()
                .filter(model -> model.getName() != null && modelName.equalsIgnoreCase(model.getName()))
    ...
    public List<CarrosRetornoQueryResult> obterAnosPorModelo(String vehicleType, String brandName, String modelName) {
        ...
        List<CarrosRetornoQueryResult> anos = fipeFeignClient.obterAnosPorMarcaEModelo(vehicleType, brandId, modelId);
    ...
    private CarrosRetornoQueryResult toMarcaQueryResult(CarrosRetornoQueryResult brand) {
