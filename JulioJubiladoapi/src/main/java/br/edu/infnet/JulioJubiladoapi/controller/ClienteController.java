...
public class ClienteController {
	...
	public ResponseEntity<Cliente> alternarFiado(@PathVariable UUID id) {
	...
	@GetMapping
	public ResponseEntity<Page<Cliente>> obterLista(Pageable pageable) {
		return ResponseEntity.ok(clienteService.obterLista(pageable));
	}
	...
	public ResponseEntity<Cliente> obterPorCpf(
			...
			String cpf) {
		return ResponseEntity.ok(clienteService.obterPorCpf(cpf));
	}
