...
public class Funcionario extends Pessoa {
    ...
    @Valid // Garante que o objeto endereço aninhado também seja validado
    private Endereco endereco;
    
    //TODO contrutor padrão do funcionario para marcar o funcionario como ativo
    //TODO Construtor com os campos de pessoa e os demais campos de funcionario
	
	
    @Override
    public String toString() {
        return String.format("Funcionario{%s, cargo=%s, turno=%s, escolaridade=%s, dataNascimento=%s, salario=%.2f, ativo=%s, dataContratacao=%s, dataDemissao=%s, endereco=%s}",
            super.toString(), cargo, turno, escolaridade, dataNascimento, salario, ativo, dataContratacao, dataDemissao, endereco
        );
    }
